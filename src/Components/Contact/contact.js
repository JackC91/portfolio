...
export default function Contact() {
    return (
        <div id="contact" className="contact_me">
            ...
            <p className="contact_body">Thanks for making it this far! If you're still wanting to know more about me check out my GitHub page, LinkedIn, or contact me via email.</p>

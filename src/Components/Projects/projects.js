...
const weekTwelveText = "As part of a team of week this app was built over the course of four weeks for our final project in the School of Code Bootcamp 12. The picture above will take you to the fully deployed version of the app, the fron and back end repos can be found on my personal GitHub account."
  ...
  return (
    <div id="project">
      ...
      <div className="projects">
        ...
        <ProjectCard text={weekTwelveText} src={require("../../Care-full.png")} alt="screenshot of week 12 app"/>
